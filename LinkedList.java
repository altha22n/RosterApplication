/**
 * This is a class to initialize a linked list 
...
public class LinkedList<T> {
	 ...
	 */
	protected LinkedListNode<T> getFirstNode() {
		return head;
	}
	 ...
	 */
	protected void insertAfter(LinkedListNode<T> currentNode, T data) {
	 ...
	 */
	protected void insertLast(T data) {
		//create a new node 
		LinkedListNode<T> newNode = new LinkedListNode<T>(data);
	 ...
	 * the tail), do nothing
	 */
	protected void deleteNext(LinkedListNode<T> currentNode) {
	...
	public String toString() {
		...
		//while current node isn't null
		while (currentNode != null){
			//add current node to my list 
			myList+= currentNode.toString();
			//then get next
			currentNode = currentNode.getNext();
		}
